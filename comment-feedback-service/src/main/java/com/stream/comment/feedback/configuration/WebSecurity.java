package com.stream.comment.feedback.configuration;


import com.stream.comment.feedback.filter.AuthorizedOrUnauthorizedCheckingEntryPoint;
...
public class WebSecurity {
	...
	@Autowired
	public WebSecurity(AuthorizedOrUnauthorizedCheckingEntryPoint unauthorizedHandler) {
		super();
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.csrf(csrf -> csrf.disable())
				...
				.authorizeHttpRequests(authorizationManagerRequestMatcherRegistry -> authorizationManagerRequestMatcherRegistry
								...
								.requestMatchers("/api/posts/**","/api/test/**","/swagger-ui.html", "/swagger-ui/**", "/swagger-ui/index.html", "/v3/api-docs").permitAll()
