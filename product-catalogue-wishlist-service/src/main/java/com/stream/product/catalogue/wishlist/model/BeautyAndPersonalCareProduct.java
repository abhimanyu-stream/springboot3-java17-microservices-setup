...
@AllArgsConstructor
@Entity
@Table(name = "beauty_and_personal_care_product")
public class BeautyAndPersonalCareProduct implements Product {
    ...
    public boolean equals(Object o) {
        ...
        BeautyAndPersonalCareProduct that = (BeautyAndPersonalCareProduct) o;
